window.onload = function () {
    ...
    sendButton.onclick = function () {
      ...
      var paymentMethodID=-200;

      if(paymentMethod.value=='Check')
      paymentMethodID=4;
      else if(paymentMethod.value=='Credit'||paymentMethod.value=='Credit Card'||paymentMethod.value=='Credit card'||paymentMethod.value=='credit Card'||paymentMethod.value=='credit card'||paymentMethod.value=='Creditcard'||paymentMethod.value=='creditcard'||paymentMethod.value=='credit')
      paymentMethodID=2;
      else if(paymentMethod.value=='Debit'||paymentMethod.value=='Debit Card'||paymentMethod.value=='debit'||paymentMethod.value=='Debit card'||paymentMethod.value=='DebitCard'||paymentMethod.value=='debit Card'||paymentMethod.value=='debit card'||paymentMethod.value=='debitcard'||paymentMethod.value=='debitCard')
      paymentMethodID=3;
      ...
      if (ok == 0)
        ...
        xmlhttp.open("POST", "/createReceipt/uploadReceipt");
